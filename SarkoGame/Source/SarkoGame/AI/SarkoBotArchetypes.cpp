...
namespace
{
	FSarkoBotArchetype Row(const TCHAR* Id, float WalkSpeed, float MaxHealth, float Damage,
		float FireIntervalSeconds, float HearingRadiusUU, float FiringRangeUU)
	{
		...
		Archetype.HearingRadiusUU = HearingRadiusUU;
...
const TArray<FSarkoBotArchetype>& SarkoAI::GetBotArchetypes()
{
	...
	static const TArray<FSarkoBotArchetype> Archetypes = {
		...
		Row(TEXT("scav_pistol"), 300.f, 60.f, 22.f, 2.0f, 1400.f, 1100.f),
		Row(TEXT("scav_smg"),    340.f, 70.f, 16.f, 1.3f, 1600.f, 1100.f),
		Row(TEXT("scout"),       420.f, 45.f, 14.f, 1.8f, 2000.f,  900.f),
	};
	return Archetypes;
}
